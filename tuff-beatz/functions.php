...
require_once get_template_directory() . '/inc/site-editor-click-edit.php';
...
require_once get_template_directory() . '/inc/file-manager-asset-sync.php';
...
require_once get_template_directory() . '/inc/business-profitability.php';
require_once get_template_directory() . '/inc/business-overhead.php';
require_once get_template_directory() . '/inc/business-trends.php';
require_once get_template_directory() . '/inc/business-scorecard.php';
require_once get_template_directory() . '/inc/business-action-center.php';
require_once get_template_directory() . '/inc/business-kpi-control.php';
...
require_once get_template_directory() . '/inc/controlled-automation-policy.php';
require_once get_template_directory() . '/inc/controlled-automation-runtime.php';
