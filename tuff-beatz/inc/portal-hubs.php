...
/** TUFF BEATZ V8.5 — Producer + Client Portal Hubs */
...
function tuff_beatz_portal_hub_assets(){if(is_page(array('producer-portal','client-portal','producer-crm'))){$p=get_template_directory().'/assets/css/portal-hubs.css';wp_enqueue_style('tuff-beatz-portal-hubs',get_template_directory_uri().'/assets/css/portal-hubs.css',array('tuff-beatz-main'),file_exists($p)?filemtime($p):wp_get_theme()->get('Version'));}}
add_action('wp_enqueue_scripts','tuff_beatz_portal_hub_assets',50);
